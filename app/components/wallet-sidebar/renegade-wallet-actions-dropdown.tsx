...
import { useConfig, useCurrentChain, useRememberMe } from "@/providers/state-provider/hooks";
...
export function RenegadeWalletActionsDropdown({ wallet }: RenegadeWalletActionsDropdownProps) {
    ...
    return (
        <>
            <DropdownMenuLabel className="text-xs font-normal">{wallet.id}</DropdownMenuLabel>
            <DropdownMenuSeparator />
            <DropdownMenuGroup>
                <DropdownMenuItem disabled={!wallet.isConnected} onSelect={handleCopyWalletId}>
                    <Clipboard />
                    Copy ID
                </DropdownMenuItem>
                <DropdownMenuItem disabled={!wallet.isConnected} onSelect={handleRefreshWallet}>
                    <RefreshCw />
                    Sync wallet
                </DropdownMenuItem>
                <DropdownMenuItem
            ...
            <DropdownMenuSeparator />
            <DropdownMenuGroup>
                <DropdownMenuItem disabled={!wallet.isConnected} onSelect={handleDisconnect}>
                    <SquareX />
                    Disconnect
                </DropdownMenuItem>
            </DropdownMenuGroup>
