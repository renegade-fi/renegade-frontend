        ...
        <div className="flex min-h-screen items-center justify-center">
            <div className="flex w-1/3 flex-col items-center justify-center gap-4 text-pretty rounded-lg p-6 text-center text-sm">
                ...
                <p className="text-muted-foreground">
                    We&apos;re on it, but feel free to reach out by clicking the button in the
                    bottom right.
                </p>
                <Image alt="spinning-renegade" height={450} src="/r.gif" width={800} />
                <div className="flex flex-col">
                    ...
                    <p className="text-muted-foreground">
                        or reach out to <a href="mailto:support@renegade.fi">support@renegade.fi</a>
                    </p>
                </div>
            </div>
        </div>
