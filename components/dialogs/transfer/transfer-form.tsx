...
import { ExternalTransferDirection, formSchema } from "@/components/dialogs/transfer/helpers";
...
export function TransferForm({
    ...
    if (direction === ExternalTransferDirection.Deposit && !isBase) {
        if (
            ...
            return (
                <USDCForm className={className} form={form} header={header} onSuccess={onSuccess} />
            );
        }
    }
    return (
