...
export const CREATE_WALLET_SUCCESS =
  "Successfully created your new Renegade wallet."
...
export const LOOKUP_WALLET_SUCCESS =
  "Successfully synced wallet with on-chain state."
...
export const catchErrorWithToast = (error: Error, message?: string) => {
  if (error instanceof BaseError) {
    toast.error(
      `${message ? message + ": " : ""}${error.shortMessage || error.message}`,
    )
  } else {
